...
Significant parts of the web dev community are moving to fine grained
...
And we similarly annotate `rawVerts`, `mosaicSize`, and `destSize`
with `@reactively`.
